...
function FIRGenerator() {
  ...
  <ul>
    <li>✅ Auto-generates a professional FIR based on your input</li>
    <li>✅ Offers live preview and PDF download</li>
    <li>✅ Includes an AI Assistant to guide you through the form</li>
    <li>✅ Available in both English & Hindi (more languages soon!)</li>
    <li>✅ Built for Bharat 🇮🇳 — No legal jargon, just simple help</li>
  </ul>
  <p>
